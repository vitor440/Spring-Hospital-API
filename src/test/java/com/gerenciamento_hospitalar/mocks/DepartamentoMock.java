...
public class DepartamentoMock {
    ...
    public static Departamento mockDepartamento(int i) {
        ...
        departamento1.setNome("Nome" + i);
        departamento1.setLocalizacao("Localizacao" + i);
    ...
    public static DepartamentoRequest mockRequest(int i) {
        DepartamentoRequest request1 = new DepartamentoRequest("Nome" + i, "Localizacao" + i);
        return request1;
    }

    public static DepartamentoResponse mockResponse(int i) {
        DepartamentoResponse response1 = new DepartamentoResponse(1L, "Nome" + i, "Localizacao" + i,
