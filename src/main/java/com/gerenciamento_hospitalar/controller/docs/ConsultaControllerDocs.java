...
public interface ConsultaControllerDocs {
    ...
    ResponseEntity<ResultadoConsultaResponse> create(@PathVariable("id") Long consultaId, @RequestBody ResultadoConsultaRequest request);
    ...
    @ApiResponses({
            ...
            @ApiResponse(description = "consulta sem resultado.", responseCode = "404",
                    content = @Content(schema = @Schema(implementation = ErroResposta.class))
            )

    })
    ResponseEntity<ResultadoConsultaResponse> update(@PathVariable("id") Long consultaId, @RequestBody ResultadoConsultaRequest request);
    ...
    ResponseEntity<ResultadoConsultaResponse> delete(@PathVariable("id") Long consultaId);


    @Operation(summary = "modificar status consulta", description = "modifica o status de uma consulta.")
    @ApiResponses({
            @ApiResponse(description = "Sucesso", responseCode = "204",
                    content = @Content
            ),
    ...
    ResponseEntity<Void> modificaStatusConsulta(@PathVariable("id") Long id,
